...
The pattern fits my intuitions about extended-rhythm playing as it evades the traditional time grid.  In particular I think it fits with the way some players and musical cultures seem to organise their more-or-less-free rhythmic percussion playing, by chaining together and flexibly deforming units of time. 

I think The model also fits well with up to date neuroscience on rhythm perception. Research suggests this is best modelled as both pulse-based and stochastic; it is thought that we anticipate the next pulse event based on previous events, via a stochastic estimation mechanism (see *Rhythm Music and the Brain* by Thaut).
